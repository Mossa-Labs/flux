defmodule Flux.Sources.Source do
  ...
  type (webhook, poll, kafka, mqtt, sqs, kinesis, pubsub, rabbitmq_external,
  sftp) and a configuration map specific to that type.
  ...
  @source_types ~w(webhook poll kafka mqtt sqs kinesis pubsub rabbitmq_external sftp)
