defmodule FluxWeb.Components.UpgradePrompt do
  ...
  attr :upgrade_url, :string,
    default: Flux.Marketing.pricing_url(),
  ...
  defp feature_label(:slack_sink), do: "Slack sink"
  ...
  defp feature_label(:rabbitmq_source), do: "RabbitMQ (External) source"
  ...
  defp feature_label(:alerting), do: "Alerting & notifications"
  defp feature_label(:observability), do: "Freshness, volume & schema observability"
